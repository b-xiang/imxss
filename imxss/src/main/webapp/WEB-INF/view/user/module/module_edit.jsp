						...
						<div class="tpl-form-body tpl-form-line">
							<form class="am-form tpl-form-line-form" id="dataform"
								...
								<div class="am-form-group">
									...
									<div class="am-u-sm-9">
										<input type="text" class="tpl-form-input" id="user-name"
											name="remark" placeholder="请填写模板描述" minlength="6"
											maxlength="32" value="${moduleInfo.remark }">
									</div>
								</div>
								<div class="am-form-group">
									<label for="user-intro" class="am-u-sm-3 am-form-label">模板代码</label>
									<div class="am-u-sm-9">
										<textarea class="" name="content" rows="10" id="user-intro"
								...
								<c:if
									test="${empty moduleInfo || moduleInfo.userId==curr_login_user.id }">
									<div class="am-form-group">
