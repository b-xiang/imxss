<%@page import="org.etrick.server.comm.util.DateUtils"%>
<%@page import="java.util.Date"%>
<%@page import="org.etrick.server.handle.system.SystemHandle"%>
														...
														<c:if
															...
															<tr>
																...
																(${annotation.fields })
																			...
																			<b class="pub">${(empty field.modifier)?'friendly':field.modifier}&nbsp;${field.isStatic?'static':'' }&nbsp;${field.isFinal?'final':'' }&nbsp;</b>
																			...
																			&nbsp;=&nbsp; <input class="blue am-monospace"
																				...
																				value="${field.fieldValue==null?'null':fn:replace(fn:replace(field.fieldValue, '\"', ''),'\'','') }">
																		</div>
														...
														<tr>
															<td>
																...
																(${annotation.fields })
																	...
																	<b class="pub">${(empty method.modifier)?'friendly':method.modifier}&nbsp;${method.isStatic?'static':'' }&nbsp;${method.isFinal?'final':'' }&nbsp;${method.isAbstract?'abstract':'' }&nbsp;${method.isSynchronized?'synchronized':'' }</b>&nbsp;${method.returnType.name }&nbsp;${method.name }(
