...
<body class="login-container">
	<div class="login-box">
		...
		<form action="do_install.jsp" class="am-form" data-am-validator
				...
				<div class="am-panel-bd">
					<div class="am-form-group line">
						<label for="doc-vld-name-2"><i
							...
							name="host" minlength="10" maxlength="36"
							placeholder="数据库IP:端口" required />
					</div>
					<div class="am-form-group line">
						<label for="doc-vld-name-2"><i class="am-icon-user"></i></label> <input
							type="text" id="email" name="dbUser" minlength="2"
							maxlength="36" placeholder="数据库用户名" required />
					</div>
					<div class="am-form-group line">
			...
			<button class="am-btn am-btn-secondary loginButton" type="submit" id="loginButton">安装</button>
		</form>
	</div>
</body>
<script>
