package org.etrick.server.web.controller.xss;
...
import org.etrick.server.handle.thread.XssThreadHandle;
...
public class XssController extends BaseController {
	...
	private void doApi(Integer id,String referer,Map<String, String> paraMap,String basePath,String ip,Integer moduleId){
		...
		try {
			...
			logger.debug("邮件发送成功:" + context + ";" + userInfo.getEmail());
		} catch (Exception e) {
