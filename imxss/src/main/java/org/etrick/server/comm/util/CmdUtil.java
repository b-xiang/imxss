...
import org.etrick.server.comm.annotation.ParamCheck;
...
import org.etrick.server.comm.constant.FormatFinal;
...
public class CmdUtil {
	...
	public static void main(String[] args) {
		String currMatcher = null;
		String [] format={FormatFinal.EMAIL,FormatFinal.USER_NAME};
