...
import org.etrick.framework.context.entity.CtAnnotationEntity;
...
public class SimpleUtil {
	...
	public static String getMethodCacheKey(Class<?> clazz, Method method) {
		...
		sb.append(")");
		return EtrickFinal.METHOD_CACHE_KEY + "-" + sb.toString();
	}
